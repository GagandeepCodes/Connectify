...
const Home = () => {
    ...
    const getUser = async(_id) => {
        const res = await getUserInfo(_id,user?.token);
                    ...
                    <div className='w-full flex flex-col gap-4 pt-4'>
                        {
                            friendRequest?.map(({ _id, requestFrom : from}) => (
                                <div key={_id} className='flex items-center justify-center'>
                                    ...
                                    className='w-full flex items-center text-ascent-1 gap-4 cursor-pointer'
                                    >
                                    <img src={from?.profileUrl ?? NoProfile} alt={from?.firstName} 
                                    className='w-10 h-10 object-cover rounded-full'
                                    />
                                        <div className='flex-1'>
                                            <p className='text-base font-medium font-ascent-1'>
